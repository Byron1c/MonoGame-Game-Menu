...
namespace MenuManager.ScreenSystem
{
    ...
    public class InputAction
    {
        ...
        private delegate bool MouseButtonPress(MouseButtons mouseButton, PlayerIndex? controllingPlayer, out PlayerIndex player);
        ...
        public InputAction(Buttons[] buttons, Keys[] keys, MouseButtons[] mouseButtons, bool newPressOnly)
        {
            ...
            this.mouseButtons = mouseButtons != null ? mouseButtons.Clone() as MouseButtons[] : new MouseButtons[0];
