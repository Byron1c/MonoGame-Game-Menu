...
namespace MenuManager.ScreenSystem
{
    ...
    public class ScreenManager : DrawableGameComponent
    {
        ...
        public ScreenTypes ScreenTypeCurrent;

        public Color BackgroundColour = Color.HotPink;
        ...
        public void graphicsInitialize()
        {
            ...
            _graphics.PreferredBackBufferWidth = SettingsManager.GetResolutionWidth(SettingsManager.Settings.Resolution);//MysteriousIsland.Environment.Common.ResolutionWidth;
            _graphics.PreferredBackBufferHeight = SettingsManager.GetResolutionHeight(SettingsManager.Settings.Resolution); // MysteriousIsland.Environment.Common.ResolutionHeight;

            _graphics.SynchronizeWithVerticalRetrace = true;

            _graphics.PreferMultiSampling = false;  // TODO: put into settings
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            if (this.ScreenTypeCurrent != ScreenTypes.Game)
            {
                GraphicsDevice.Clear(Color.Black);
            }
            else
            {
                GraphicsDevice.Clear(this.BackgroundColour);
                //Console.WriteLine(this.BackgroundColour.ToString());
            }
        ...
        {
            _spriteBatch.Begin();
            _spriteBatch.Draw(blankTexture, GraphicsDevice.Viewport.Bounds, Color.Black * alpha);
            _spriteBatch.End();
        }
        ...
        public void RemoveTopScreen()
        {
            ...
            GameScreen screen = _screens[_screens.Count - 1];
